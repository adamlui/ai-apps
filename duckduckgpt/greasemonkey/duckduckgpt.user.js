...
(async () => {
    ...
    const config = {
        ...
        latestAssetCommitHash: '0ea208e' } // for cached messages.json
    ...
    const modals = {
        ...
        about: {
            show() {
                ...
                aboutModal.insertBefore(aboutHeaderLogo, aboutModal.firstChild)
                aboutHeaderLogo.width = 310 ; update.appLogoSrc()
