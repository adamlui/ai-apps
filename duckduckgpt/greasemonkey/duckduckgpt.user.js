...
(async () => {
    ...
    const config = {
        ...
        latestAssetCommitHash: '7841933' } // for cached messages.json
    ...
    const menus = {
        ...
        pin: {
            ...
            createAppend() {
                ...
                pinMenu.classList.add('ddgpt-menu', 'fade-in-less', 'no-user-select')
            ...
            update(pinMenu) {
                ...
                for (let i = 0 ; i < 4 ; i++) {
                    ...
                    if (i == 0) { // format header item
                        ...
                        pinMenuItems[i].classList.add('ddgpt-menu-header') // to not apply hover fx in appStyle
    ...
    const update = {
        ...
        appStyle() {
            appStyle.innerText = (
              ...
              + '.ddgpt-menu ul { padding: 5.5px 0 ; margin: 0 ; list-style: none }'
              + '.ddgpt-menu-item { padding: 0 10px ; line-height: 20.5px }'
        ...
        tooltip(buttonType) { // text & position
            ...
            const [ctrAddend, spreadFactor] = appDiv.querySelector('.standby-btn') ? [11, 29] : [9, 29],
