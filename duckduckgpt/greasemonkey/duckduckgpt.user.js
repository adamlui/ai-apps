...
// @antifeature            ads A very tiny text ad displays below DuckDuckGPT chatbar ~50% of the time (only in Sidebar mode). This motivates me to spend otherwise unpaid time upgrading script w/ new features & APIs.
