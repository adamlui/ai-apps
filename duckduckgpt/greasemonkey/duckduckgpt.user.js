...
(async () => {
    ...
    Object.assign(app, { settings: {
        ...
        autoGet: { type: 'toggle', icon: 'speechBalloonLasso',
            ...
            helptip: app.msgs.helptip_autoGetAnswers || 'Auto-send queries to DuckDuckGPT when using search engine' },
        ...
        stickySidebar: { type: 'toggle', mobile: false, centered: false, icon: 'webCorner',
            ...
            helptip: app.msgs.helptip_stickySidebar || 'Makes DuckDuckGPT visible in sidebar even as you scroll' },
        anchored: { type: 'toggle', mobile: false, centered: false, icon: 'anchor',
            label: app.msgs.mode_anchor || 'Anchor Mode',
            helptip: app.msgs.helptip_anchorMode || 'Anchor DuckDuckGPT to bottom of window' },
        ...
        replyLanguage: { type: 'prompt', icon: 'languageChars',
            ...
            helptip: app.msgs.helptip_replyLanguage || 'Language for DuckDuckGPT to reply in' },
        scheme: { type: 'modal', icon: 'scheme',
            label: app.msgs.menuLabel_colorScheme || 'Color Scheme',
            helptip: app.msgs.helptip_colorScheme || 'Scheme to display DuckDuckGPT UI components in' },
