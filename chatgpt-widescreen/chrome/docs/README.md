...
1. Install **ChatGPT Widescreen Mode** from the [Chrome Web Store](https://chrome.chatgptwidescreen.com) or the [Edge Add-on Store](https://edge.chatgptwidescreen.com)
