...
ChatGPT Widescreen Mode is also available as a [Chrome extension](https://chrome.chatgptwidescreen.com), an [Edge add-on](https://edge.chatgptwidescreen.com) and a [Greasemonkey userscript](https://greasyfork.chatgptwidescreen.com) (via [Tampermonkey](https://www.tampermonkey.net)).
