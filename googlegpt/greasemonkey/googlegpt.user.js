...
// @description         Adds ChatGPT answers to Google Search sidebar (powered by GPT-4o + Google Gemma!)
// @description:af      Voeg ChatGPT-antwoorde by Google Soek kantbalk by (aangedryf deur GPT-4o + Google Gemma!)
// @description:am      የChatGPT መልስናወርቃለች እርስዎን በGoogle የተወሰኑ ገጽታዎችን ይጨምሩ (ተከፋይ GPT-4o + Google Gemma!)
// @description:ar      يضيف إجابات ChatGPT إلى شريط البحث الجانبي في Google (مدعوم بواسطة GPT-4o + Google Gemma!)
// @description:az      ChatGPT cavablarını Google Axtarış yan panelinə əlavə edir (GPT-4o + Google Gemma tərəfindən işlədilir!)
// @description:be      Дадае адказы ChatGPT да бакавой баковай панэлі Google Search (з дапамогай GPT-4o + Google Gemma!)
// @description:bem     Aziya ChatGPT ndalama ku Google sidebar (yezagwirizwitsa ndi GPT-4o + Google Gemma!)
// @description:bg      Добавя ChatGPT отговори към страничната лента на Google Search (с поддръжка от GPT-4o + Google Gemma!)
// @description:bn      Google সাইডবারে ChatGPT উত্তর যোগ করে (দ্বারা GPT-4o + Google Gemma প্রস্তুত!)
// @description:bo      ChatGPT ལེ་བས་ཚད་བདག་སྐྱེད་དེ་བཟུམ་སྒྲིག་ནང་ Google གནས་པ་བརྗོད་པ། (GPT-4o + Google Gemma སྒྲིག་དང་སྤྱི་བོར་ཡོད་ཡིག!)
// @description:bs      Dodaje odgovore ChatGPT-a na bočnu traku Google pretrage (pokreće GPT-4o + Google Gemma!)
// @description:ca      Afegeix respostes de ChatGPT a la barra lateral de Google Search (impulsat per GPT-4o + Google Gemma!)
// @description:ceb     Nagdugang sa mga tubag sa ChatGPT sa sidebar sa Google Search (pinaagi sa gihimong GPT-4o + Google Gemma!)
// @description:ckb     وەرگرتنی ڕاستەوخۆیی ChatGPT بۆ پەنجەرەی لاتی لە Google (پشتیوانیکراوە لە لایەن GPT-4o + Google Gemma!)
// @description:cs      Přidává odpovědi od ChatGPT do bočního panelu Google Search (poháněno GPT-4o + Google Gemma!)
// @description:cy      Ychwanega Atebion ChatGPT i'r bar ochr Google Chwilio (pŵerwyd gan GPT-4o + Google Gemma!)
// @description:da      Tilføjer ChatGPT-svar til Google Søg-sidelinjen (drevet af GPT-4o + Google Gemma!)
// @description:de      Fügt ChatGPT-Antworten zur Google-Seitenleiste hinzu (unterstützt von GPT-4o + Google Gemma!)
// @description:dv      ChatGPT އައިކްސޭޓުގެ ޖަވާބުގެ Google ސައިޓުގައި ފޯރުވާރައުގެ ޑައުން (GPT-4o + Google Gemma! ތަފްޞީލް)
// @description:dz      ChatGPT དང་ Google འབྱུང་ཆུང་ལེ་བས་འཐུས་པ་ལགས་སྤྱོད་སྒྲིག་པ་བརྟགས། (GPT-4o + Google Gemma རྒྱབས་བྱས་ཏེ!)
// @description:el      Προσθέτει απαντήσεις ChatGPT στην πλαϊνή γραμμή αναζήτησης του Google (τροφοδοτούμενο από το GPT-4o + Google Gemma!)
// @description:eo      Aldonas ChatGPT-respondojn al la flanka breto de Google Serĉo (motorigita de GPT-4o + Google Gemma!)
// @description:es      Agrega respuestas de ChatGPT a la barra lateral de Google (impulsado por GPT-4o + Google Gemma!)
// @description:et      Lisab ChatGPT vastused Google otsingu küljepaneelile (toetatud GPT-4o + Google Gemma poolt!)
// @description:eu      Gehitu ChatGPT erantzunak Google bilaketa aldean (eredua: GPT-4o + Google Gemma!)
// @description:fa      ChatGPT به پاسخهای Google جستجو نوار کناری اضافه میکند (قدرت گرفته شده توسط GPT-4o + Google Gemma!)
// @description:fi      Lisää ChatGPT-vastaukset Googleen (teknologia: GPT-4o + Google Gemma!)
// @description:fil     Nagdaragdag ng mga sagot ng ChatGPT sa sidebar ng Google Search (pinaandar ng GPT-4o + Google Gemma!)
// @description:fj      Vakarautaka na vosa vakatotolo ni ChatGPT ki na yasa ni liga ni Google (veivakatovolei e na GPT-4o + Google Gemma!)
// @description:fo      Leggur ChatGPT-svar til Google Leita síðustriku (róbotrýni: GPT-4o + Google Gemma!)
// @description:fr      Ajoute les réponses ChatGPT à la barre latérale Google (alimenté par GPT-4o + Google Gemma!)
// @description:fr-CA   Ajoute les réponses ChatGPT à la barre latérale Google (alimenté par GPT-4o + Google Gemma!)
// @description:ga      Cuireann freagraí ChatGPT le taobhliosta Google Cuardach (cumhachtaithe ag GPT-4o + Google Gemma!)
// @description:gd      Cuir freagairtean ChatGPT ris an taobh-siostam Google Lorg (cumhachd le GPT-4o + Google Gemma!)
// @description:gl      Engade as respostas de ChatGPT á barra lateral de procura de Google (potenciado por GPT-4o + Google Gemma!)
// @description:gn      Oñemohẽ ChatGPT ñemohendu Google Ñepyrũ (teknologia: GPT-4o + Google Gemma!)
// @description:gu      Google સાઇડબારમાં ChatGPT જવાબો ઉમેરે છે (પાવર્ડ બાય GPT-4o + Google Gemma!)
// @description:ha      Zaya sauyaƙa daga ChatGPT zuwa bidiyo na bidiyon Google (kara na GPT-4o + Google Gemma!)
// @description:haw     Hoʻohui aku i nā hōʻike a ChatGPT i ka papa aoʻao hema o ka ʻimi ʻana iā Google (hoʻolako ʻia e GPT-4o + Google Gemma!)
// @description:he      הוספת תשובות ChatGPT לסרגל הצד של Google חיפוש (הופעל על ידי GPT-4o + Google Gemma!)
// @description:hi      Google साइडबार में ChatGPT उत्तर जोड़ता है (पावर्ड बाय GPT-4o + Google Gemma!)
// @description:hr      Dodaje odgovore aplikacije ChatGPT bočnoj traci pretraživanja Google (pokreće GPT-4o + Google Gemma!)
// @description:ht      Ajoute repons ChatGPT nan barre laterale Rechèch Google a (pòtansye pa GPT-4o + Google Gemma!)
// @description:hu      A ChatGPT válaszokat ad a Google Keresés oldalsávjához (hajtja: GPT-4o + Google Gemma!)
// @description:hy      Ավելացնում է ChatGPT պատասխանները Google որոնումի կողմից (աշխատում է GPT-4o + Google Gemma!-ով)
// @description:id      Menambahkan jawaban ChatGPT ke sidebar Google Search (didukung oleh GPT-4o + Google Gemma!)
// @description:ig      Tinye obere ChatGPT na-aga n'etiti ozi akụkụ Google Search (na-atụgharị nke GPT-4o + Google Gemma!)
// @description:is      Bætir við ChatGPT svarum við hliðina á Google leitarstiku (af þjónustu: GPT-4o + Google Gemma!)
// @description:it      Aggiunge le risposte ChatGPT alla barra laterale di Google (alimentato da GPT-4o + Google Gemma!)
// @description:iu      ᐊᑎᒪᐃᓐᓂᐊᕐᓂᖅ ChatGPT ᐅᖃᐅᓯᒻᓂᒃ Google ᑎᑎᕋᖅ (ᐅᓪᓗᒥᒄ GPT-4o + Google Gemma-ᓇ!)
// @description:ja      ChatGPT の回答を Google サイドバーに追加します (powered by GPT-4o + Google Gemma!)
// @description:jv      Nambaki jawaban ChatGPT menyang sidebar Google Search (didukung déning GPT-4o + Google Gemma!)
// @description:ka      დაამატებს ChatGPT პასუხებს Google ძიების გვერდზე (ძალაში შენერგვაში: GPT-4o + Google Gemma!)
// @description:kg      Kweyisa mawu a ChatGPT kuna sebukulu Google Search (olengisa na GPT-4o + Google Gemma!)
// @description:kk      Google іздеу жолағына ChatGPT жауаптарын қосады (жеткілік: GPT-4o + Google Gemma арқылы!)
// @description:kl      Innersuarmi Google Search-imi ChatGPT-imit akissutit ilannguppai (GPT-4o + Google Gemma-mik piareersagaasoq!)
// @description:km      បន្ថែមចម្លើយដែលបានបញ្ចូលដោយ ChatGPT ទៅខ្សែសំខាន់ Google (គ្រប់គ្រងដោយ GPT-4o + Google Gemma!)
// @description:kn      Google ಹುಡುಕಾಟ ಸೈಡ್ಬಾರ್ಗೆ ChatGPT ಉತ್ತರಗಳನ್ನು ಸೇರಿಸುತ್ತದೆ (GPT-4o + Google Gemma ಮೂಲಕ ನಡೆಸಲ್ಪಡುತ್ತಿದೆ!)
// @description:ko      ChatGPT 답변을 Google 검색 사이드바에 추가합니다 (GPT-4o + Google Gemma!으로 구동됨)
// @description:kok     Google शोधाच्या बाजुस चॅटजीपीटी उत्तर घालतो (शक्ती: GPT-4o + Google Gemma!)
// @description:kr      Yanaɓa aiki na ChatGPT na ƙasaɓa ta hannu zuwa baya na Google (da aka buga da GPT-4o + Google Gemma!)
// @description:ks      ChatGPT د جوابونو Google لټون مخ (د: GPT-4o + Google Gemma! لخوا)
// @description:ku      Berhev dike le bersivên ChatGPTê Google Search (teqezkirina li GPT-4o + Google Gemma!)
// @description:ky      Google издөө жолунда ChatGPT жооптарын кошотот (өндүрүү: GPT-4o + Google Gemma!)
// @description:la      Adde ChatGPT responsa ad latere Google quaerere (motus a GPT-4o + Google Gemma!)
// @description:lb      Setzt ChatGPT Äntwerten derbäi Google Sichbar (gedréift vun GPT-4o + Google Gemma!)
// @description:lg      Yamba okuba y'oluganda wa ChatGPT mu kisangibwa kya Google (ebizimbe bya GPT-4o + Google Gemma!)
// @description:ln      Ekómi kosunga na makambo ya ChatGPT na moto ya Google Search (ezalaki na molimo na GPT-4o + Google Gemma!)
// @description:lo      ເພີ່ມຄຳຕອບ ChatGPT ເຂົ້າໃຈການຄົ້ນຫາ Google (ສະຫຼັບໄດ້ຂອງ GPT-4o + Google Gemma!)
// @description:lt      Prideda ChatGPT atsakymus į Google paieškos šoninę juostą (varomas GPT-4o + Google Gemma!)
// @description:lv      Pievieno ChatGPT atbildes Google meklēšanas sānjoslai (piedziņā: GPT-4o + Google Gemma!)
// @description:mg      Manampy olana amin'ny Google Search amin'ny sary ho an'ny fiaraha-monina izay mitovy (nataon'i GPT-4o + Google Gemma!)
// @description:mh      Ekwe jej ki en̄aaj tuon Google Search io ikwoor ChatGPT jerbal (koṃro: GPT-4o + Google Gemma!)
// @description:mi      Tāpirihia ngā whakautu o ChatGPT ki te tekau Google (whakaratohia e GPT-4o + Google Gemma!)
// @description:mk      Додава одговори на ChatGPT на страничниот Google бар (поддржано од GPT-4o + Google Gemma!)
// @description:ml      ഗൂഗിൾ തിരച്ചിലിന്റെ സൈഡ്ബാർലേക്ക് ചാറ്റിജിപിടി ഉത്തരങ്ങൾ ചേർക്കുന്നു (ശക്തിശാലിയായി GPT-4o + Google Gemma യില്‍!)
// @description:mn      Google хайлтын зүүний самбарт ChatGPT хариултууд нэмэх (тэмдэглэл: GPT-4o + Google Gemma!)
// @description:mr      Google शोध बाजुस ChatGPT प्रत्युत्तर जोडतो (शक्ती: GPT-4o + Google Gemma!)
// @description:ms      Menambah jawapan ChatGPT ke sidebar Carian Google (dikuasakan oleh GPT-4o + Google Gemma!)
// @description:mt      Żid it-tweġibiet tal-ChatGPT għas-sidebar tal-Google Search (ippreżentat min (powered by GPT-4o + Google Gemma!)
// @description:my      Google ရှိ ChatGPT အဖြေကိုထည့်သွင်းရန် (လွှဲပြီးနောက် powered by GPT-4o + Google Gemma!)
// @description:na      Ongerenga mei a ChatGPT i le tofiga o Google Suʻesuʻega (ʻo fesoasoaniʻi e GPT-4o + Google Gemma!)
// @description:nb      Legger til ChatGPT-svar i Google Søk sidefelt (drevet av GPT-4o + Google Gemma!)
// @description:nd      Ithunyelwe izithuthi za ChatGPT kuqukethwe kwesibhakabhaka seGoogle Search (lithuthukisiwe ngu GPT-4o + Google Gemma!)
// @description:ne      Google खोजको साइडबारमा ChatGPT उत्तरहरू थप्दै (पावर द्वारा GPT-4o + Google Gemma!)
// @description:ng      Ongeza mafandikio ya ChatGPT ku tepu ya Google Search (ifananyishwa na GPT-4o + Google Gemma!)
// @description:nl      Voegt ChatGPT-antwoorden toe aan de zijkant van Google Zoeken (aangedreven door GPT-4o + Google Gemma!)
// @description:nn      Legg til ChatGPT-svar i Google Søk sidefelt (drevet av GPT-4o + Google Gemma!)
// @description:no      Legger til ChatGPT-svar i Google Søk sidefelt (drevet av GPT-4o + Google Gemma!)
// @description:nso     E ngata re tswetše diphetho tša ChatGPT go setšhabeng sa Google Search (nthusa ke GPT-4o + Google Gemma!)
// @description:ny      Ndadzivula mawu a ChatGPT ku sesele ya Google Search (ganizidwa ndi GPT-4o + Google Gemma!)
// @description:oc      Apond las responsas de ChatGPT a la barra laterala de Google Search (potenciat per GPT-4o + Google Gemma!)
// @description:om      Fayyadamnu Google Ayyaanni ChatGPT tiwwiiqaa garaa garaatti argachuu dandeenyu (Qaldama GPT-4o + Google Gemma!)
// @description:or      ଗୁଗଲ ଖୋଜର ସାଇଡବାରରେ ChatGPT ଉତ୍ତର ଯୋଡ଼ାଯାଇଛି (ଦ୍ବାରା ପ୍ରଦାନ କରାଯାଇଛି powered by GPT-4o + Google Gemma!)
// @description:pa      ਗੂਗਲ ਖੋਜ ਦੇ ਸਾਈਡਬਾਰ 'ਚ ChatGPT ਉੱਤਰ ਸ਼ਾਮਲ ਕੀਤੇ ਗਏ ਨੇ (ਪਾਵਰਡ ਬਾਈ GPT-4o + Google Gemma!)
// @description:pl      Dodaje odpowiedzi ChatGPT w pasku bocznym Google (zasilany przez GPT-4o + Google Gemma!)
// @description:ps      د ګوګل لټون کې ChatGPT جو جوابون اضافو ګيل آهی (د پوهاندۍ لخوا GPT-4o + Google Gemma!)
// @description:pt      Adiciona respostas do ChatGPT à barra lateral do Google Search (alimentado por GPT-4o + Google Gemma!)
// @description:pt-BR   Adiciona respostas do ChatGPT à barra lateral do Google Search (alimentado por GPT-4o + Google Gemma!)
// @description:qu      ChatGPT munankunapuraqmi Google ñawpa pachapi yanapaq (ñuqayku GPT-4o + Google Gemma! shinalla)
// @description:rm      Agiunta las respostas da ChatGPT a la barra laterala da Google Search (potenzià da GPT-4o + Google Gemma!)
// @description:rn      Abaririza amajwi nka ChatGPT ku rubuga rw'ikibazo cya Google (yamitabiriwe na GPT-4o + Google Gemma!)
// @description:ro      Adaugă răspunsurile ChatGPT în bara laterală Google Căutare (alimentat de GPT-4o + Google Gemma!)
// @description:ru      Добавляет ответы ChatGPT на боковую панель Google (при поддержке GPT-4o + Google Gemma!)
// @description:rw      Byongeyeza amajwi yo mubu sideba ya Google ChatGPT (akomokwa na GPT-4o + Google Gemma!)
// @description:sa      गूगल यान्त्रिके अभिन्नधीयो मार्गेण चाटगिपटिं उत्तरम् (आह्वानित by GPT-4o + Google Gemma!)
// @description:sat     Googleᱥ ᱵᱟᱨᱦᱟᱨᱚᱛ ᱠᱟᱹᱞᱤᱞᱟ ChatGPT ᱨᱮᱞᱟ ᱦᱚᱱᱮᱡ (ᱱᱚᱢᱮᱱᱟᱹ ᱠᱚ GPT-4o + Google Gemma! ᱨᱮᱫ)
// @description:sc      Aghedda is responsas de ChatGPT a sa barra de cerca de Google (potziu da GPT-4o + Google Gemma!)
// @description:sd      گوگل سرچ ۾ ChatGPT جو جوابون اضافو ڪيل آهي (پاوريو بائي GPT-4o + Google Gemma!)
// @description:se      Loahpa ChatGPT-vástádusat Google Gaskkaside (suorggahan de GPT-4o + Google Gemma!)
// @description:sg      Tisa na tîsânga lusângo lu ChatGPT kuna ntsâdi ya Google (wuha na GPT-4o + Google Gemma!)
// @description:si      Google සෙවුමේ ChatGPT පිළිතුරු එකතු කරයි (බලාපොරොත්තු බෙදාහරින්නෙයි GPT-4o + Google Gemma! හාදුව)
// @description:sk      Pridáva odpovede ChatGPT do bočnej lišty vyhľadávania Google (poháňané GPT-4o + Google Gemma!)
// @description:sl      Dodaja odgovore ChatGPT v stransko vrstico iskanja Google (omogoča GPT-4o + Google Gemma!)
// @description:sm      Faʻaalia atonu a le ChatGPT i le taavale lautele o le Google Suʻesuʻega (faʻamalosi e GPT-4o + Google Gemma!)
// @description:sn      Kupurikira maitiro eChatGPT kuve kuwandisa wevhu raGoogle Search (akatengeswa na GPT-4o + Google Gemma!)
// @description:so      Ku darin xogta ChatGPT ee gooshi Google Search (caawinaysa GPT-4o + Google Gemma!)
// @description:sq      Shton përgjigje ChatGPT në anëbardhën e kërkimit Google (përcjellur nga GPT-4o + Google Gemma!)
// @description:sr      Додаје одговоре ЧатГПТ-а у траку за претрагу Google (покреће GPT-4o + Google Gemma!)
// @description:ss      Faka amavulandlela aseChatGPT e sidebarenge sikaGoogle Seaching (sikwazisiwe ngu GPT-4o + Google Gemma!)
// @description:st      Kgetha ChatGPT ho litlhopho tsa Google Thetsa (elelisa ka GPT-4o + Google Gemma!)
// @description:su      Nambihan jawaban ChatGPT ka sisi kiri Google (dikuwit oleh GPT-4o + Google Gemma!)
// @description:sv      Lägger till ChatGPT-svar i Google-sökraden (drivs av GPT-4o + Google Gemma!)
// @description:sw      Inaongeza majibu ya ChatGPT kwenye ubao wa upande wa Google (imetengenezwa na GPT-4o + Google Gemma!)
// @description:ta      கூகிள் தேடலின் பக்கத்தில் ChatGPT பதில்களைச் சேர்க்கின்றது (பவர்டராக்கப்பட்டது GPT-4o + Google Gemma!)
// @description:te      గూగుల్ శోధన పట్టిక పై ChatGPT సమాధానాలను జోడిస్తుంది (యాంకరులు ద్వారా GPT-4o + Google Gemma సంచాలితం!)
// @description:tg      Зиёд кардани ҷавобҳои ChatGPT ба тарафи сатҳи ҷустуҷӯ Google (саркашӣ шуда аз GPT-4o + Google Gemma!)
// @description:th      เพิ่มคําตอบจาก ChatGPT ในแถบด้านข้างของการค้นหา Google (สนับสนุนโดย GPT-4o + Google Gemma!)
// @description:ti      ኣብ Google ስልጠና ኣብ ChatGPT ምልክትን ኣማራጺ (ዘበክን በተለዋዋጭ ኣብዚ powered by GPT-4o + Google Gemma!)
// @description:tk      Google gecikmäge ChatGPT jogaby goşýar (GPT-4o + Google Gemma tarapyndan işledilýär!)
// @description:tl      Nagdadagdag ng mga sagot ng ChatGPT sa sidebar ng Google Search (pinaandar ng GPT-4o + Google Gemma!)
// @description:tn      Viseza izisho zika ChatGPT kwekhoni leGoogle Search (kusetjentšwe ke GPT-4o + Google Gemma!)
// @description:to      Tānaki e ngaue kihe sipa tali fakapotopoto 'o e Google ngaue 'o e ChatGPT (tohi e ngaahi sivi 'i he founga kehekehe 'o e GPT-4o + Google Gemma!)
// @description:tr      ChatGPT yanıtlarını Google Arama kenar çubuğuna ekler (GPT-4o + Google Gemma tarafından desteklenir!)
// @description:ts      Vuyisa mati na ChatGPT hi xiphemu leGoogle Search (na ku hluvukelwe hi GPT-4o + Google Gemma!)
// @description:tt      Google Эзләү үтекле ChatGPT катнаштыру (GPT-4o + Google Gemma ґалиматымен күреніс!)
// @description:tw      Hwɛ ChatGPT adefoɔ dodoɔ Google hwee (ete woawo na GPT-4o + Google Gemma!)
// @description:ug      Google ئىزدەشتە ChatGPT جاۋابلىرىنى قوشۇش (GPT-4o + Google Gemma بىلەن قۇرغان!)
// @description:uk      Додає відповіді ChatGPT у бічний панелі пошуку Google (працює на GPT-4o + Google Gemma!)
// @description:ur      گوگل تلاش کی طرف ChatGPT کے جوابات شامل کرتا ہے (GPT-4o + Google Gemma کی مدد سے!)
// @description:uz      Google qidiruviga ChatGPT javoblari qo'shadi (GPT-4o + Google Gemma tomonidan qo'llaniladi!)
// @description:ve      Vhohodzi vha ChatGPT kha vhavhili ya Google Fambisa (vhathwedzwa na GPT-4o + Google Gemma!)
// @description:vi      Thêm câu trả lời của ChatGPT vào thanh bên Google Search (được hỗ trợ bởi GPT-4o + Google Gemma!)
// @description:vo      Läükon datans ChatGPT ad pät binon Google Vükos (ö pükonömi jö GPT-4o + Google Gemma!)
// @description:wa      Ådd doveses di Dj ChatGPT a l' cohteye di Dj Google (djuwé pa GPT-4o + Google Gemma!)
// @description:wo      Ndax duggëwul ChatGPT du bind ak wertali Google (waaye bu GPT-4o + Google Gemma!)
// @description:xh      Nika izicelo zika ChatGPT ezinkunzi ngesandla samazwi eGoogle Search (kumgangatho ngu GPT-4o + Google Gemma!)
// @description:yi      צוגעפיגט אַנטוואָרטן פון טשאַטגפּט אין גוגל זוכן זייַטבאַר (געפּאָווערעד דורך GPT-4o + Google Gemma!)
// @description:yo      Fi awọn iwe itumọ ChatGPT si abala iwoye Google (ni idawọ GPT-4o + Google Gemma!)
// @description:za      Ngozv yi ChatGPT nv nqgozv ya Google Search (gyaeqnganh GPT-4o + Google Gemma!)
// @description:zh      将 ChatGPT 答案添加到 Google 侧边栏 (由 GPT-4o + Google Gemma 提供支持!)
// @description:zh-CN   将 ChatGPT 答案添加到 Google 侧边栏 (由 GPT-4o + Google Gemma 提供支持!)
// @description:zh-HK   將 ChatGPT 答案添加到 Google 側邊欄 (由 GPT-4o + Google Gemma 提供支援!)
// @description:zh-SG   将 ChatGPT 答案添加到 Google 侧边栏 (由 GPT-4o + Google Gemma 提供支持!)
// @description:zh-TW   將 ChatGPT 答案添加到 Google 側邊欄 (由 GPT-4o + Google Gemma 提供支援!)
...
(async () => {
    ...
    config.assetHostURL = config.gitHubURL.replace('github.com', 'cdn.jsdelivr.net/gh') + '@bb2241b/'
