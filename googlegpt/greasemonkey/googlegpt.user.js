...
(async () => {
    ...
    Object.assign(app, { settings: {
        ...
        autoGet: { type: 'toggle', icon: 'speechBalloonLasso',
            ...
            helptip: app.msgs.helptip_autoGetAnswers || 'Auto-send queries to GoogleGPT when using search engine' },
        ...
        stickySidebar: { type: 'toggle', mobile: false, icon: 'webCorner',
            ...
            helptip: app.msgs.helptip_stickySidebar || 'Makes GoogleGPT visible in sidebar even as you scroll' },
        anchored: { type: 'toggle', mobile: false, icon: 'anchor',
            label: app.msgs.mode_anchor || 'Anchor Mode',
            helptip: app.msgs.helptip_anchorMode || 'Anchor GoogleGPT to bottom of window' },
        ...
        replyLanguage: { type: 'prompt', icon: 'languageChars',
            ...
            helptip: app.msgs.helptip_replyLanguage || 'Language for GoogleGPT to reply in' },
        scheme: { type: 'modal', icon: 'scheme',
            label: app.msgs.menuLabel_colorScheme || 'Color Scheme',
            helptip: app.msgs.helptip_colorScheme || 'Scheme to display GoogleGPT UI components in' },
        ...
        feedback: {
            show(options) {
                ...
                const feedbackModalID = siteAlert(`${
                    app.msgs.alert_choosePlatform || 'Choose a platform' }:`, '', btns, '', 333)
    ...
    const toggle = {
        ...
        tooltip(event) {
            ...
            tooltipDiv.innerText = (
              ...
              : btnType == 'shuffle' ? app.msgs.tooltip_feelingLucky || 'I\'m Feeling Lucky' : '' )
