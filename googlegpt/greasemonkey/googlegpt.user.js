...
(async () => {
    ...
    const config = {
        ...
        latestAssetCommitHash: '4bf7c74' } // for cached messages.json
            ...
            return new Promise(resolve => {
                ...
                function arrayify(strList) { // for get.related() calls
                    return (strList.match(/\d+\.\s*(.*?)(?=\n|\\n|$)/g) || [])
                        ...
                        .map(match => match.replace(/^(?:\d+\.)?\s*['"*]*|['"*]*$/, '')) // strip numbering + quotes
                }
        })}
    }
    ...
    const show = {
        ...
        copyBtns() {
            if (appDiv.querySelector('#googlegpt > pre > svg, code > svg')) return
        ...
        reply(answer) {
            ...
            if (!appDiv.querySelector('pre')) {
                ...
                if (!isMobile) {
                    ...
                    chevronSpan.style.margin = '-3.5px 1px 0 11px'
                ...
                aboutSpan.style.marginTop = `${ isMobile ? 0.25 : -0.15 }rem`
                ...
                settingsSpan.style.margin = `${ isMobile ? 3 : -3 }px 10px 0 2.5px`
                ...
                if (!isMobile) {
                    ...
                    pinSpan.style.margin = '-1.55px 7.5px 0 0'
                ...
                // Create/append Wider Sidebar button
                    ...
                    wsbSpan.style.margin = '-2px 12px 0 0'
                ...
                // Create/append Expand/Shrink button
                    ...
                    arrowsSpan.style.margin = '-1.5px 12px 0 0'
