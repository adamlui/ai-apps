...
(async () => {
    ...
    const config = {
        ...
        latestAssetCommitHash: '734bc94' } // for cached messages.json
    ...
    const logos = {
        googleGPT: {
            ...
            create() {
                const googleGPTlogo = document.createElement('img') ; googleGPTlogo.id = 'googlegpt-logo'
    ...
    const update = {
        ...
        appStyle() {
            ...
            + '[class$="modal"] {' // native modals + chatgpt.alert()s
              ...
              + '#scheme-menu-entry > span { margin: -2px -2px 0 !important }' // align Scheme status
        ...
        scheme(newScheme) {
            scheme = newScheme ; logos.googleGPT.update() ; update.appStyle() ; update.stars() ; toggle.btnGlow() ; 
