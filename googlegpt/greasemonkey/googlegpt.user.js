...
// @description:am      የChatGPT መልስናወርቃለች እርስዎን በGoogle የተወሰኑ ገጽታዎችን ይጨምሩ (ተከፋይ Google Gemma + GPT-4o!)
// @description:ar      يضيف إجابات ChatGPT إلى شريط البحث الجانبي في Google (مدعوم بواسطة Google Gemma + GPT-4o!)
// @description:az      ChatGPT cavablarını Google Axtarış yan panelinə əlavə edir (Google Gemma + GPT-4o tərəfindən işlədilir!)
// @description:be      Дадае адказы ChatGPT да бакавой баковай панэлі Google Search (з дапамогай Google Gemma + GPT-4o!)
// @description:bem     Aziya ChatGPT ndalama ku Google sidebar (yezagwirizwitsa ndi Google Gemma + GPT-4o!)
// @description:bg      Добавя ChatGPT отговори към страничната лента на Google Search (с поддръжка от Google Gemma + GPT-4o!)
// @description:bn      Google সাইডবারে ChatGPT উত্তর যোগ করে (দ্বারা Google Gemma + GPT-4o প্রস্তুত!)
// @description:bo      ChatGPT ལེ་བས་ཚད་བདག་སྐྱེད་དེ་བཟུམ་སྒྲིག་ནང་ Google གནས་པ་བརྗོད་པ། (Google Gemma + GPT-4o སྒྲིག་དང་སྤྱི་བོར་ཡོད་ཡིག!)
// @description:bs      Dodaje odgovore ChatGPT-a na bočnu traku Google pretrage (pokreće Google Gemma + GPT-4o!)
...
// @description:ckb     وەرگرتنی ڕاستەوخۆیی ChatGPT بۆ پەنجەرەی لاتی لە Google (پشتیوانیکراوە لە لایەن Google Gemma + GPT-4o!)
// @description:cs      Přidává odpovědi od ChatGPT do bočního panelu Google Search (poháněno Google Gemma + GPT-4o!)
// @description:cy      Ychwanega Atebion ChatGPT i'r bar ochr Google Chwilio (pŵerwyd gan Google Gemma + GPT-4o!)
// @description:da      Tilføjer ChatGPT-svar til Google Søg-sidelinjen (drevet af Google Gemma + GPT-4o!)
// @description:de      Fügt ChatGPT-Antworten zur Google-Seitenleiste hinzu (unterstützt von Google Gemma + GPT-4o!)
// @description:dv      ChatGPT އައިކްސޭޓުގެ ޖަވާބުގެ Google ސައިޓުގައި ފޯރުވާރައުގެ ޑައުން (Google Gemma + GPT-4o! ތަފްޞީލް)
// @description:dz      ChatGPT དང་ Google འབྱུང་ཆུང་ལེ་བས་འཐུས་པ་ལགས་སྤྱོད་སྒྲིག་པ་བརྟགས། (Google Gemma + GPT-4o རྒྱབས་བྱས་ཏེ!)
// @description:el      Προσθέτει απαντήσεις ChatGPT στην πλαϊνή γραμμή αναζήτησης του Google (τροφοδοτούμενο από το Google Gemma + GPT-4o!)
// @description:eo      Aldonas ChatGPT-respondojn al la flanka breto de Google Serĉo (motorigita de Google Gemma + GPT-4o!)
// @description:es      Agrega respuestas de ChatGPT a la barra lateral de Google (impulsado por Google Gemma + GPT-4o!)
// @description:et      Lisab ChatGPT vastused Google otsingu küljepaneelile (toetatud Google Gemma + GPT-4o poolt!)
// @description:eu      Gehitu ChatGPT erantzunak Google bilaketa aldean (eredua: Google Gemma + GPT-4o!)
// @description:fa      ChatGPT به پاسخهای Google جستجو نوار کناری اضافه میکند (قدرت گرفته شده توسط Google Gemma + GPT-4o!)
// @description:fi      Lisää ChatGPT-vastaukset Googleen (teknologia: Google Gemma + GPT-4o!)
...
// @description:fo      Leggur ChatGPT-svar til Google Leita síðustriku (róbotrýni: Google Gemma + GPT-4o!)
// @description:fr      Ajoute les réponses ChatGPT à la barre latérale Google (alimenté par Google Gemma + GPT-4o!)
// @description:fr-CA   Ajoute les réponses ChatGPT à la barre latérale Google (alimenté par Google Gemma + GPT-4o!)
// @description:ga      Cuireann freagraí ChatGPT le taobhliosta Google Cuardach (cumhachtaithe ag Google Gemma + GPT-4o!)
// @description:gd      Cuir freagairtean ChatGPT ris an taobh-siostam Google Lorg (cumhachd le Google Gemma + GPT-4o!)
// @description:gl      Engade as respostas de ChatGPT á barra lateral de procura de Google (potenciado por Google Gemma + GPT-4o!)
// @description:gn      Oñemohẽ ChatGPT ñemohendu Google Ñepyrũ (teknologia: Google Gemma + GPT-4o!)
// @description:gu      Google સાઇડબારમાં ChatGPT જવાબો ઉમેરે છે (પાવર્ડ બાય Google Gemma + GPT-4o!)
// @description:ha      Zaya sauyaƙa daga ChatGPT zuwa bidiyo na bidiyon Google (kara na Google Gemma + GPT-4o!)
// @description:haw     Hoʻohui aku i nā hōʻike a ChatGPT i ka papa aoʻao hema o ka ʻimi ʻana iā Google (hoʻolako ʻia e Google Gemma + GPT-4o!)
// @description:he      הוספת תשובות ChatGPT לסרגל הצד של Google חיפוש (הופעל על ידי Google Gemma + GPT-4o!)
// @description:hi      Google साइडबार में ChatGPT उत्तर जोड़ता है (पावर्ड बाय Google Gemma + GPT-4o!)
// @description:hr      Dodaje odgovore aplikacije ChatGPT bočnoj traci pretraživanja Google (pokreće Google Gemma + GPT-4o!)
// @description:ht      Ajoute repons ChatGPT nan barre laterale Rechèch Google a (pòtansye pa Google Gemma + GPT-4o!)
// @description:hu      A ChatGPT válaszokat ad a Google Keresés oldalsávjához (hajtja: Google Gemma + GPT-4o!)
// @description:hy      Ավելացնում է ChatGPT պատասխանները Google որոնումի կողմից (աշխատում է Google Gemma + GPT-4o!-ով)
// @description:id      Menambahkan jawaban ChatGPT ke sidebar Google Search (didukung oleh Google Gemma + GPT-4o!)
// @description:ig      Tinye obere ChatGPT na-aga n'etiti ozi akụkụ Google Search (na-atụgharị nke Google Gemma + GPT-4o!)
// @description:is      Bætir við ChatGPT svarum við hliðina á Google leitarstiku (af þjónustu: Google Gemma + GPT-4o!)
// @description:it      Aggiunge le risposte ChatGPT alla barra laterale di Google (alimentato da Google Gemma + GPT-4o!)
// @description:iu      ᐊᑎᒪᐃᓐᓂᐊᕐᓂᖅ ChatGPT ᐅᖃᐅᓯᒻᓂᒃ Google ᑎᑎᕋᖅ (ᐅᓪᓗᒥᒄ Google Gemma + GPT-4o-ᓇ!)
// @description:ja      ChatGPT の回答を Google サイドバーに追加します (powered by Google Gemma + GPT-4o!)
// @description:jv      Nambaki jawaban ChatGPT menyang sidebar Google Search (didukung déning Google Gemma + GPT-4o!)
// @description:ka      დაამატებს ChatGPT პასუხებს Google ძიების გვერდზე (ძალაში შენერგვაში: Google Gemma + GPT-4o!)
// @description:kg      Kweyisa mawu a ChatGPT kuna sebukulu Google Search (olengisa na Google Gemma + GPT-4o!)
// @description:kk      Google іздеу жолағына ChatGPT жауаптарын қосады (жеткілік: Google Gemma + GPT-4o арқылы!)
// @description:kl      Innersuarmi Google Search-imi ChatGPT-imit akissutit ilannguppai (Google Gemma + GPT-4o-mik piareersagaasoq!)
// @description:km      បន្ថែមចម្លើយដែលបានបញ្ចូលដោយ ChatGPT ទៅខ្សែសំខាន់ Google (គ្រប់គ្រងដោយ Google Gemma + GPT-4o!)
// @description:kn      Google ಹುಡುಕಾಟ ಸೈಡ್ಬಾರ್ಗೆ ChatGPT ಉತ್ತರಗಳನ್ನು ಸೇರಿಸುತ್ತದೆ (Google Gemma + GPT-4o ಮೂಲಕ ನಡೆಸಲ್ಪಡುತ್ತಿದೆ!)
// @description:ko      ChatGPT 답변을 Google 검색 사이드바에 추가합니다 (Google Gemma + GPT-4o!으로 구동됨)
// @description:kok     Google शोधाच्या बाजुस चॅटजीपीटी उत्तर घालतो (शक्ती: Google Gemma + GPT-4o!)
// @description:kr      Yanaɓa aiki na ChatGPT na ƙasaɓa ta hannu zuwa baya na Google (da aka buga da Google Gemma + GPT-4o!)
// @description:ks      ChatGPT د جوابونو Google لټون مخ (د: Google Gemma + GPT-4o! لخوا)
// @description:ku      Berhev dike le bersivên ChatGPTê Google Search (teqezkirina li Google Gemma + GPT-4o!)
// @description:ky      Google издөө жолунда ChatGPT жооптарын кошотот (өндүрүү: Google Gemma + GPT-4o!)
// @description:la      Adde ChatGPT responsa ad latere Google quaerere (motus a Google Gemma + GPT-4o!)
// @description:lb      Setzt ChatGPT Äntwerten derbäi Google Sichbar (gedréift vun Google Gemma + GPT-4o!)
// @description:lg      Yamba okuba y'oluganda wa ChatGPT mu kisangibwa kya Google (ebizimbe bya Google Gemma + GPT-4o!)
// @description:ln      Ekómi kosunga na makambo ya ChatGPT na moto ya Google Search (ezalaki na molimo na Google Gemma + GPT-4o!)
// @description:lo      ເພີ່ມຄຳຕອບ ChatGPT ເຂົ້າໃຈການຄົ້ນຫາ Google (ສະຫຼັບໄດ້ຂອງ Google Gemma + GPT-4o!)
// @description:lt      Prideda ChatGPT atsakymus į Google paieškos šoninę juostą (varomas Google Gemma + GPT-4o!)
// @description:lv      Pievieno ChatGPT atbildes Google meklēšanas sānjoslai (piedziņā: Google Gemma + GPT-4o!)
...
// @description:mh      Ekwe jej ki en̄aaj tuon Google Search io ikwoor ChatGPT jerbal (koṃro: Google Gemma + GPT-4o!)
// @description:mi      Tāpirihia ngā whakautu o ChatGPT ki te tekau Google (whakaratohia e Google Gemma + GPT-4o!)
// @description:mk      Додава одговори на ChatGPT на страничниот Google бар (поддржано од Google Gemma + GPT-4o!)
// @description:ml      ഗൂഗിൾ തിരച്ചിലിന്റെ സൈഡ്ബാർലേക്ക് ചാറ്റിജിപിടി ഉത്തരങ്ങൾ ചേർക്കുന്നു (ശക്തിശാലിയായി Google Gemma + GPT-4o യില്‍!)
// @description:mn      Google хайлтын зүүний самбарт ChatGPT хариултууд нэмэх (тэмдэглэл: Google Gemma + GPT-4o!)
// @description:mr      Google शोध बाजुस ChatGPT प्रत्युत्तर जोडतो (शक्ती: Google Gemma + GPT-4o!)
// @description:ms      Menambah jawapan ChatGPT ke sidebar Carian Google (dikuasakan oleh Google Gemma + GPT-4o!)
// @description:mt      Żid it-tweġibiet tal-ChatGPT għas-sidebar tal-Google Search (ippreżentat min (powered by Google Gemma + GPT-4o!)
// @description:my      Google ရှိ ChatGPT အဖြေကိုထည့်သွင်းရန် (လွှဲပြီးနောက် powered by Google Gemma + GPT-4o!)
// @description:na      Ongerenga mei a ChatGPT i le tofiga o Google Suʻesuʻega (ʻo fesoasoaniʻi e Google Gemma + GPT-4o!)
// @description:nb      Legger til ChatGPT-svar i Google Søk sidefelt (drevet av Google Gemma + GPT-4o!)
...
// @description:ne      Google खोजको साइडबारमा ChatGPT उत्तरहरू थप्दै (पावर द्वारा Google Gemma + GPT-4o!)
...
// @description:nn      Legg til ChatGPT-svar i Google Søk sidefelt (drevet av Google Gemma + GPT-4o!)
// @description:no      Legger til ChatGPT-svar i Google Søk sidefelt (drevet av Google Gemma + GPT-4o!)
// @description:nso     E ngata re tswetše diphetho tša ChatGPT go setšhabeng sa Google Search (nthusa ke Google Gemma + GPT-4o!)
...
// @description:or      ଗୁଗଲ ଖୋଜର ସାଇଡବାରରେ ChatGPT ଉତ୍ତର ଯୋଡ଼ାଯାଇଛି (ଦ୍ବାରା ପ୍ରଦାନ କରାଯାଇଛି powered by Google Gemma + GPT-4o!)
// @description:pa      ਗੂਗਲ ਖੋਜ ਦੇ ਸਾਈਡਬਾਰ 'ਚ ChatGPT ਉੱਤਰ ਸ਼ਾਮਲ ਕੀਤੇ ਗਏ ਨੇ (ਪਾਵਰਡ ਬਾਈ Google Gemma + GPT-4o!)
// @description:pl      Dodaje odpowiedzi ChatGPT w pasku bocznym Google (zasilany przez Google Gemma + GPT-4o!)
// @description:ps      د ګوګل لټون کې ChatGPT جو جوابون اضافو ګيل آهی (د پوهاندۍ لخوا Google Gemma + GPT-4o!)
// @description:pt      Adiciona respostas do ChatGPT à barra lateral do Google Search (alimentado por Google Gemma + GPT-4o!)
// @description:pt-BR   Adiciona respostas do ChatGPT à barra lateral do Google Search (alimentado por Google Gemma + GPT-4o!)
// @description:qu      ChatGPT munankunapuraqmi Google ñawpa pachapi yanapaq (ñuqayku Google Gemma + GPT-4o! shinalla)
// @description:rm      Agiunta las respostas da ChatGPT a la barra laterala da Google Search (potenzià da Google Gemma + GPT-4o!)
// @description:rn      Abaririza amajwi nka ChatGPT ku rubuga rw'ikibazo cya Google (yamitabiriwe na Google Gemma + GPT-4o!)
// @description:ro      Adaugă răspunsurile ChatGPT în bara laterală Google Căutare (alimentat de Google Gemma + GPT-4o!)
// @description:ru      Добавляет ответы ChatGPT на боковую панель Google (при поддержке Google Gemma + GPT-4o!)
// @description:rw      Byongeyeza amajwi yo mubu sideba ya Google ChatGPT (akomokwa na Google Gemma + GPT-4o!)
// @description:sa      गूगल यान्त्रिके अभिन्नधीयो मार्गेण चाटगिपटिं उत्तरम् (आह्वानित by Google Gemma + GPT-4o!)
// @description:sat     Googleᱥ ᱵᱟᱨᱦᱟᱨᱚᱛ ᱠᱟᱹᱞᱤᱞᱟ ChatGPT ᱨᱮᱞᱟ ᱦᱚᱱᱮᱡ (ᱱᱚᱢᱮᱱᱟᱹ ᱠᱚ Google Gemma + GPT-4o! ᱨᱮᱫ)
// @description:sc      Aghedda is responsas de ChatGPT a sa barra de cerca de Google (potziu da Google Gemma + GPT-4o!)
// @description:sd      گوگل سرچ ۾ ChatGPT جو جوابون اضافو ڪيل آهي (پاوريو بائي Google Gemma + GPT-4o!)
// @description:se      Loahpa ChatGPT-vástádusat Google Gaskkaside (suorggahan de Google Gemma + GPT-4o!)
// @description:sg      Tisa na tîsânga lusângo lu ChatGPT kuna ntsâdi ya Google (wuha na Google Gemma + GPT-4o!)
// @description:si      Google සෙවුමේ ChatGPT පිළිතුරු එකතු කරයි (බලාපොරොත්තු බෙදාහරින්නෙයි Google Gemma + GPT-4o! හාදුව)
// @description:sk      Pridáva odpovede ChatGPT do bočnej lišty vyhľadávania Google (poháňané Google Gemma + GPT-4o!)
// @description:sl      Dodaja odgovore ChatGPT v stransko vrstico iskanja Google (omogoča Google Gemma + GPT-4o!)
// @description:sm      Faʻaalia atonu a le ChatGPT i le taavale lautele o le Google Suʻesuʻega (faʻamalosi e Google Gemma + GPT-4o!)
...
// @description:sq      Shton përgjigje ChatGPT në anëbardhën e kërkimit Google (përcjellur nga Google Gemma + GPT-4o!)
// @description:sr      Додаје одговоре ЧатГПТ-а у траку за претрагу Google (покреће Google Gemma + GPT-4o!)
...
// @description:sv      Lägger till ChatGPT-svar i Google-sökraden (drivs av Google Gemma + GPT-4o!)
// @description:sw      Inaongeza majibu ya ChatGPT kwenye ubao wa upande wa Google (imetengenezwa na Google Gemma + GPT-4o!)
// @description:ta      கூகிள் தேடலின் பக்கத்தில் ChatGPT பதில்களைச் சேர்க்கின்றது (பவர்டராக்கப்பட்டது Google Gemma + GPT-4o!)
// @description:te      గూగుల్ శోధన పట్టిక పై ChatGPT సమాధానాలను జోడిస్తుంది (యాంకరులు ద్వారా Google Gemma + GPT-4o సంచాలితం!)
// @description:tg      Зиёд кардани ҷавобҳои ChatGPT ба тарафи сатҳи ҷустуҷӯ Google (саркашӣ шуда аз Google Gemma + GPT-4o!)
// @description:th      เพิ่มคําตอบจาก ChatGPT ในแถบด้านข้างของการค้นหา Google (สนับสนุนโดย Google Gemma + GPT-4o!)
// @description:ti      ኣብ Google ስልጠና ኣብ ChatGPT ምልክትን ኣማራጺ (ዘበክን በተለዋዋጭ ኣብዚ powered by Google Gemma + GPT-4o!)
// @description:tk      Google gecikmäge ChatGPT jogaby goşýar (Google Gemma + GPT-4o tarapyndan işledilýär!)
// @description:tl      Nagdadagdag ng mga sagot ng ChatGPT sa sidebar ng Google Search (pinaandar ng Google Gemma + GPT-4o!)
// @description:tn      Viseza izisho zika ChatGPT kwekhoni leGoogle Search (kusetjentšwe ke Google Gemma + GPT-4o!)
// @description:to      Tānaki e ngaue kihe sipa tali fakapotopoto 'o e Google ngaue 'o e ChatGPT (tohi e ngaahi sivi 'i he founga kehekehe 'o e Google Gemma + GPT-4o!)
// @description:tr      ChatGPT yanıtlarını Google Arama kenar çubuğuna ekler (Google Gemma + GPT-4o tarafından desteklenir!)
// @description:ts      Vuyisa mati na ChatGPT hi xiphemu leGoogle Search (na ku hluvukelwe hi Google Gemma + GPT-4o!)
// @description:tt      Google Эзләү үтекле ChatGPT катнаштыру (Google Gemma + GPT-4o ґалиматымен күреніс!)
// @description:tw      Hwɛ ChatGPT adefoɔ dodoɔ Google hwee (ete woawo na Google Gemma + GPT-4o!)
// @description:ug      Google ئىزدەشتە ChatGPT جاۋابلىرىنى قوشۇش (Google Gemma + GPT-4o بىلەن قۇرغان!)
// @description:uk      Додає відповіді ChatGPT у бічний панелі пошуку Google (працює на Google Gemma + GPT-4o!)
// @description:ur      گوگل تلاش کی طرف ChatGPT کے جوابات شامل کرتا ہے (Google Gemma + GPT-4o کی مدد سے!)
...
// @description:vi      Thêm câu trả lời của ChatGPT vào thanh bên Google Search (được hỗ trợ bởi Google Gemma + GPT-4o!)
// @description:vo      Läükon datans ChatGPT ad pät binon Google Vükos (ö pükonömi jö Google Gemma + GPT-4o!)
// @description:wa      Ådd doveses di Dj ChatGPT a l' cohteye di Dj Google (djuwé pa Google Gemma + GPT-4o!)
// @description:wo      Ndax duggëwul ChatGPT du bind ak wertali Google (waaye bu Google Gemma + GPT-4o!)
// @description:xh      Nika izicelo zika ChatGPT ezinkunzi ngesandla samazwi eGoogle Search (kumgangatho ngu Google Gemma + GPT-4o!)
// @description:yi      צוגעפיגט אַנטוואָרטן פון טשאַטגפּט אין גוגל זוכן זייַטבאַר (געפּאָווערעד דורך Google Gemma + GPT-4o!)
// @description:yo      Fi awọn iwe itumọ ChatGPT si abala iwoye Google (ni idawọ Google Gemma + GPT-4o!)
// @description:za      Ngozv yi ChatGPT nv nqgozv ya Google Search (gyaeqnganh Google Gemma + GPT-4o!)
// @description:zh      将 ChatGPT 答案添加到 Google 侧边栏 (由 Google Gemma + GPT-4o 提供支持!)
// @description:zh-CN   将 ChatGPT 答案添加到 Google 侧边栏 (由 Google Gemma + GPT-4o 提供支持!)
// @description:zh-HK   將 ChatGPT 答案添加到 Google 側邊欄 (由 Google Gemma + GPT-4o 提供支援!)
// @description:zh-SG   将 ChatGPT 答案添加到 Google 侧边栏 (由 Google Gemma + GPT-4o 提供支持!)
// @description:zh-TW   將 ChatGPT 答案添加到 Google 側邊欄 (由 Google Gemma + GPT-4o 提供支援!)
