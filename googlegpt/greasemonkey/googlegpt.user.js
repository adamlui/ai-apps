...
(async () => {
    ...
    config.assetHostURL = config.gitHubURL.replace('github.com', 'cdn.jsdelivr.net/gh') + '@cd76f95/'
    ...
    function updateAppStyle() {
        appStyle.innerText = (
          ...
          + '.related-query {'
              ...
              + `border: 1px solid ${ scheme == 'dark' ? '#777' : '#e1e1e1' } ; font-size: ${ isMobile ? 1.18 : 0.81}em ; cursor: pointer ;`
