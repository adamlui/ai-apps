<div align="right">
    <h6>
        ...
        &nbsp;English |
        <a href="https://github.chatgptautocontinue.com/blob/main/docs/zh-cn/SECURITY.md">简体中文</a>
    </h6>
</div>

# 🛡️ Security Policy

If you find a vulnerability, please open a [draft security advisory](https://github.chatgptautocontinue.com/security/advisories/new).
