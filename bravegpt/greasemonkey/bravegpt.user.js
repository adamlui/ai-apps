...
(async () => {
    ...
    function braveGPTshow(answer) {
        ...
        speakSpan.className = 'speak' ; speakSpan.title = messages.tooltip_playAnswer
    ...
    braveGPTstyle.innerText = (
        ...
        + '@keyframes pulse { 0%, to { opacity: 1 } 50% { opacity: .5 }}'
        + '.balloon-tip { content: "" ; position: relative ; top: 0.25em ; right: 9.78rem ; border: 7px solid transparent ;'
