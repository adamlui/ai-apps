...
setTimeout(async () => {
    ...
    const config = {
        ...
        latestAssetCommitHash: '6ff07ce' } // for cached messages.json
    ...
    const update = {
        ...
        appStyle() {
            appStyle.innerText = (
              ...
              + '.standby-btn { width: 100% ; margin: 14px 0 20px ; padding: 13px 0 ; cursor: pointer ; outline: none ;'
              ...
              + '.related-query {'
                  ...
                  + `border: 1px solid ${ scheme == 'dark' ? '#777' : '#e1e1e1' } ; font-size: 0.77em ; cursor: pointer ; outline: none ;`
        ...
        scheme(newScheme) {
            scheme = newScheme ; logos.braveGPT.update()
